import{g as w,s as p,u as $,a as _,c as x,b as L,d as y}from"./assets/header-CsJQOtaS.js";import{a as d,i as l,S}from"./assets/vendor-X-nWYsMu.js";const C=document.querySelectorAll(".span-counter"),g=document.querySelector(".modal-window-shop"),E=document.querySelector(".list-one");let n=w();u();E.addEventListener("click",async t=>{if(t.preventDefault(),t.target.classList.contains("textUpHover")){document.body.classList.add("modal-open");const e=t.target.parentNode.dataset.category,a=(await d.get(`https://books-backend.p.goit.global/books/${e}`)).data;console.log(typeof a);let o=`
