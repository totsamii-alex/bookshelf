import{g as L,c as E,u as T,a as z,d as q,s as l}from"./assets/header-CUv6V0eE.js";import{i as v,a as M}from"./assets/vendor-X-nWYsMu.js";window.addEventListener("resize",e=>{e.preventDefault();const a=window.innerWidth;(a===1440||a===768)&&location.reload()});const b="/bookshelf/assets/isEmpty-zqgIGaxr.png",k="/bookshelf/assets/isEmpty2x-DbW8UP_T.png",p=document.querySelector(".list-books"),r=document.querySelector(".pagination"),f=document.querySelector(".container-loader"),C=document.querySelectorAll(".span-counter");let n=L();H();window.addEventListener("load",async e=>{e.preventDefault(),E(),A("Shopping List"),S()?(await u(0,g()),w()):(p.innerHTML=`
